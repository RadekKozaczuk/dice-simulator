...
namespace Common
{
    public interface ISignal
    {
        ...
        void SkillAddedSignal(SkillDto skill, int slot);

        /// <summary>
        /// Called whenever stat bonus (a.k.a. multiplicator or float) is changed.
        /// </summary>
        void StatMultiplicatorChanged(PlayerId id, float statValue, ModifierEnums.StatModifierOperation operation);
    }
}